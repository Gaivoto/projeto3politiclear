<template>
    <div class="viewWrapper">
        <EmpresariosSearch class="searchbar" v-bind:organizacoes="this.organizacoes" v-on:pesquisar="updateList"/>
        <ElementList class="lista" tipo="EmpresarioCard" v-bind:lista="this.lista"/>
