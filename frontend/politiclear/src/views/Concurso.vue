<template>
    <div>
        <ConcursoInfo v-bind:info="this.info"/>
        <router-link tag="button" v-if="possivelAlterar" :to="{path: '/concursos/'+ this.$route.params.id + '/edit'}">Alterar este concurso</router-link>
        <router-view></router-view>
        <button v-if="possivelEliminar" @click="toggleDeleteModal">Eliminar este concurso</button>
        <ConcursoInfoLists v-bind:info="this.info"/>
